...
function checkLastNamName() {
    ...
    if(pt.test(d)){
        ...
        document.getElementById("checkLastName").innerHTML=" Invalid First Name begin Uppercharacter"
        return; 
}
function checkEmail() {
...
function checkPass() {
    ...
    if(pt.test(d)){
        ...
        document.getElementById("checkPass").innerHTML="PassWord don't less 6 character"
        return; 
}